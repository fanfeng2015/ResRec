...
public class MongoDBConnection implements DBConnection {
	...
	// $pullAll will remove, from visited: [], all business id that appear in
	// the array, including duplicates
	@Override
	...
	// recommendRestaurants is exactly the same as that of
	// MySQLDBConnection.java, because this API doesn't query data from DB, but
	// instead is calling other APIs to achieve the same purpose
	@Override
	...
	// the only change is when each restaurant is inserted into DB
	@Override
